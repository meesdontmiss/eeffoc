...
export default function AlienHero({ mouseX, mouseY, isSmoking, onSmoke }: AlienHeroProps) {
  ...
  return (
    <div className="relative flex items-center justify-center select-none">
      ...
      <motion.div
        className="absolute w-[340px] h-[340px] md:w-[520px] md:h-[520px] rounded-full pointer-events-none"
        animate={{
      ...
      >
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-[260px] h-[360px] md:w-[400px] md:h-[560px] cursor-pointer"
        >
          {/* Hover glow overlay */}
          <motion.div
